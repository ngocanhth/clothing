...
from .models import Category, Clothing, Lesson, Tag
...
class CourseAppAdminSite(admin.AdminSite):
    ...
    def course_stats(self, request):
        ...
        stats = Clothing.objects.annotate(lesson_count=Count('lessonsquery')).values('id', 'subject', 'lesson_count')
...
admin.site.register(Clothing, CourseAdmin)
