...
class ItemBase(models.Model):
    ...
    image = models.ImageField(upload_to='clothing/%Y/%m/%d/', default=None)
...
class Lesson(ItemBase):
    ...
    course = models.ForeignKey(Clothing, related_name='lessons', related_query_name='lessonsquery', on_delete=models.CASCADE)
